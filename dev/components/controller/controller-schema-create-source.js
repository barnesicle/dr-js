...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "handleSchemaCreateSource": function() { return /* binding */ handleSchemaCreateSource; }
/* harmony export */ });
...
function handleSchemaCreateSource(components, schemaComponent, type, sourceRequest, apiKey) {
  ...
  return schemaComponent.send('getComponentData' + schemaComponent.id, {}).then(function (response) {
    ...
    var getDataPromises = _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_0___default()(componentIds).call(componentIds, function (componentData) {
      return components[componentData.id].send('getComponentData' + componentData.id, {}).then(function (source) {
        return {
          data: source.data,
          type: componentData.type // TODO Add to get error. If it is required or not... any of the validations have failed... . etc.
    ...
    return _babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_1___default().all(getDataPromises).then(function (data) {
      // TODO handle errors
      var ccTriggerEvents = _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_0___default()(componentIds).call(componentIds, function (data) {
        return components[data.id].send('componentTriggerEvent', {
          type: 'createSource'
        });
      });

      return _babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_1___default().all(ccTriggerEvents).then(function (triggerValues) {
        console.log('errors triggerValues', triggerValues);
        ...
        } // TODO Validate the errors. Do not send to payment service if errors exist....


        console.log('handleSchemaCreateSource data returned', data);

        _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_2___default()(data).call(data, function (elementData) {
...
/******/ })()
;
//# sourceMappingURL=controller\controller-schema-create-source.js.map