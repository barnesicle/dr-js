...
function runCreateSourceAndHandleResponse(sourceRequest, apiKey) {
  ...
  return Object(_payment_service_request__WEBPACK_IMPORTED_MODULE_3__["paymentServiceRequest"])(sourceRequest, apiKey, _config__WEBPACK_IMPORTED_MODULE_4__["config"].paymentServiceUrl, applicationHeader).then(function (response) {
...
/***/ "./src/app/components/controller/controller-schema-create-source.js":
/*!**************************************************************************!*\
  !*** ./src/app/components/controller/controller-schema-create-source.js ***!
  \**************************************************************************/
/*! exports provided: handleSchemaCreateSource */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "handleSchemaCreateSource", function() { return handleSchemaCreateSource; });
...
function handleSchemaCreateSource(components, schemaComponent, type, sourceRequest, apiKey) {
  console.log('Getting Source for', schemaComponent.id, schemaComponent.type);
  return schemaComponent.send('getComponentData' + schemaComponent.id, {}).then(function (response) {
    var componentIds = response.data;
    console.log('handleSchemaCreateSource componentIds', componentIds, components[componentIds[0].id].send);

    var getDataPromises = _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_2___default()(componentIds).call(componentIds, function (componentData) {
      return components[componentData.id].send('getComponentData' + componentData.id, {}).then(function (source) {
        return {
          data: source.data,
          type: componentData.type
        };
      });
    }); //const getDataPromises = componentIds.map( componentData => components[componentData.id].send('getComponentData', {}));
    // TODO Need to map type with element ID


    console.log('handleSchemaCreateSource', getDataPromises);
    return _babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_1___default.a.all(getDataPromises).then(function (data) {
      // TODO handle errors

      /*const triggerCCNumEvent = creditCardNumberComponent.send('componentTriggerEvent', {type: 'createSource'});
      const ccTriggerEvents = [triggerCCNumEvent, triggerCCExpireEvent, triggerCVVEvent];
      return Promise.all(ccTriggerEvents).then((triggerValues) => {
      const errors = formatComponentTriggerErrors(triggerValues);
      if (errors.length > 0) {
        return handleCreateSourceValidation(errors);
      }*/
      console.log('handleSchemaCreateSource data returned', data);

      _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_0___default()(data).call(data, function (elementData) {
        console.log('handleSchemaCreateSource elementData', elementData);
        sourceRequest[type][elementData.type] = elementData.data;
      });

      console.log('handleSchemaCreateSource BEFORE CALL', sourceRequest); //sourceRequest[type] = Object.assign({}, sourceRequest[type], data);
...
/*!********************************!*\
  !*** ./src/app/key-logging.js ***!
  \********************************/
/*! exports provided: LOGGING_APPLICATION_KEY */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LOGGING_APPLICATION_KEY", function() { return LOGGING_APPLICATION_KEY; });
...
/***/ 13:
/*!********************************************************************************!*\
  !*** multi ./src/app/components/controller/controller-schema-create-source.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\dev\ui-architecture\digitalriverpayments\src\app\components\controller\controller-schema-create-source.js */"./src/app/components/controller/controller-schema-create-source.js");


/***/ })

/******/ })));
//# sourceMappingURL=controller-schema-create-source.js.map