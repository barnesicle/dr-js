...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   handleOnlineBankingCreateSource: function() { return /* binding */ handleOnlineBankingCreateSource; },
/* harmony export */   runGetBanksAndHandleResponse: function() { return /* binding */ runGetBanksAndHandleResponse; }
/* harmony export */ });
...
function handleOnlineBankingCreateSource(componentInstance, sourceRequest, apiKey) {
  if (!componentInstance) {
    return _babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_0___default().reject('Cannot create source because all the required components have not been created for a online banking submission');
  }
  if (!componentInstance.send) {
    return _babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_0___default().reject('Cannot create source because all the required components have not been mounted for a online banking submission');
  }
  ...
  return onlineBankingPromise.then(function (ibpBankCode) {
    ...
    return triggerOnlineBanking.then(function (onlineBankingData) {
      ...
      var errors = (0,_controller_create_source_utils__WEBPACK_IMPORTED_MODULE_2__.formatComponentTriggerErrors)(values);
      if (errors.length > 0) {
        return (0,_controller_create_source_utils__WEBPACK_IMPORTED_MODULE_2__.handleCreateSourceValidation)(errors);
      }
      ...
      return (0,_controller_create_source_utils__WEBPACK_IMPORTED_MODULE_2__.runCreateSourceAndHandleResponse)(sourceRequest, apiKey);
    });
  }).catch(function (error) {
    return (0,_controller_create_source_utils__WEBPACK_IMPORTED_MODULE_2__.chooseCreateSourceCatchMessage)(error);
  });
}
...
function runGetBanksAndHandleResponse(apiKey, currency, country) {
  ...
  return (0,_payment_service_request__WEBPACK_IMPORTED_MODULE_3__.paymentServiceGetRequest)(apiKey, _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_1___default()(_context = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_1___default()(_context2 = "".concat(_config__WEBPACK_IMPORTED_MODULE_4__.config.onlineBankingBanksUrl, "?currency=")).call(_context2, currency, "&country=")).call(_context, country)).then(function (response) {
...
/******/ })()
;
//# sourceMappingURL=controller\controller-online-banking-create-source.js.map