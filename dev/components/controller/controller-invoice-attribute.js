...
/***/ "./src/app/components/error-utils.js":
/*!*******************************************!*\
  !*** ./src/app/components/error-utils.js ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   handleNetworkTimeoutError: function() { return /* binding */ handleNetworkTimeoutError; },
/* harmony export */   handleNoNetworkError: function() { return /* binding */ handleNoNetworkError; },
/* harmony export */   handleServiceCatch: function() { return /* binding */ handleServiceCatch; },
/* harmony export */   handleSingleError: function() { return /* binding */ handleSingleError; },
/* harmony export */   handleUnauthorizedError: function() { return /* binding */ handleUnauthorizedError; }
/* harmony export */ });
...
/**
 * handleSingleError resolves a promise with unknown errors failure
 * @param {string} error
 * @param {string} type
 * @returns {Promise<{error: {type: string, errors: {code: *, message: *}[]}}>}
 */
 ...
 * @returns {Promise<{error: {type: string, errors: {message: string}[]}}>}
 */
...
/**
 * handleServiceCatch resolves a promise with error data from a failed service call
 * @param {object} error
 * @returns {Promise<{error: {messages, type}}>}
 */
function handleServiceCatch(error) {
  return _babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_0___default().resolve({
...
"use strict";
/*!***********************************************************************!*\
  !*** ./src/app/components/controller/controller-invoice-attribute.js ***!
  \***********************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   chooseInvoiceAttributeCatchMessage: function() { return /* binding */ chooseInvoiceAttributeCatchMessage; },
/* harmony export */   runGetInvoiceAttributeAndHandleResponse: function() { return /* binding */ runGetInvoiceAttributeAndHandleResponse; }
/* harmony export */ });
...
/* harmony import */ var _error_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../error-utils */ "./src/app/components/error-utils.js");




function runGetInvoiceAttributeAndHandleResponse(apiKey, data) {
  return (0,_payment_service_request__WEBPACK_IMPORTED_MODULE_1__.invoiceAttributeRequest)(data, apiKey, "".concat(_config__WEBPACK_IMPORTED_MODULE_2__.config.apiUrl, "/invoice-attributes")).then(function (response) {
    return response.data;
  }).catch(function (error) {
    return chooseInvoiceAttributeCatchMessage(error);
  });
}
 ...
 * @returns {*}
 */
function chooseInvoiceAttributeCatchMessage(error) {
  if (typeof error === 'string') {
    return (0,_error_utils__WEBPACK_IMPORTED_MODULE_3__.handleSingleError)(error);
  } else if (error.response) {
    if (error.response.status === 401) {
      return (0,_error_utils__WEBPACK_IMPORTED_MODULE_3__.handleUnauthorizedError)();
    } else {
      return (0,_error_utils__WEBPACK_IMPORTED_MODULE_3__.handleServiceCatch)(error);
    }
  } else {
    var _context;
    if (error.message && _babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_0___default()(_context = error.message).call(_context, 'timeout')) {
      return (0,_error_utils__WEBPACK_IMPORTED_MODULE_3__.handleNetworkTimeoutError)();
    } else {
      return (0,_error_utils__WEBPACK_IMPORTED_MODULE_3__.handleNoNetworkError)();
    }
  }
}
}();
...
/******/ })()
;
//# sourceMappingURL=controller\controller-invoice-attribute.js.map