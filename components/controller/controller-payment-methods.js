...
function runGetPaymentMethodsAndHandleResponse(apiKey, sessionId, currency, country) {
  ...
  var paramURL = paramBuilder([sessionIdParam, currencyParam, countryParam]);
  var url = "".concat(_config__WEBPACK_IMPORTED_MODULE_1__["config"].paymentMethodsUrl).concat(paramURL);
...
function createParam(name, value) {
  return typeof value !== 'undefined' && value.length > 0 ? name + '=' + value : '';
}

function paramBuilder(params) {
  var validParams = params.filter(function (param) {
